...
import net.frostbyte.backpacksx.v1_8_R3.managers.CraftManager;
import net.frostbyte.backpacksx.v1_8_R3.managers.InventoryManager;
import net.frostbyte.backpacksx.v1_8_R3.managers.LoadingManager;
